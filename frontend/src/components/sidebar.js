...
function Sidebar({sidebarHidden}) {
    ...
    return (
        ...
        <div className={`sidebar flex flex-col gap-y-10 text-white transition-transform duration-100 ease-in-out fixed top-0 left-0 h-screen w-40 p-2 bg-sky-950 ${sidebarHidden ?'-translate-x-full': 'translate-x-0'}`}>
