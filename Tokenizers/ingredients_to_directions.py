...
if __name__ == "__main__":
    ...
    tokenizer_path = Path("ingredients_to_directions_tokenizer")
    ...
    if tokenizer_path.exists():
        ...
        special_tokens = ["[PAD]", "[UNK]", "<end_ingredients>", "<end>"]
        trainer = trainers.WordPieceTrainer(vocab_size=20000, special_tokens=special_tokens)

        string_dataset = RecipeNLGDataset(df, mode='ingredients_to_directions')
